var accuracyscore = document.getElementById('accuracyscore');
    ...
    function gettoken(){
        ...
        request.open('POST', '/SST/gettoken', true);
    ...
    hbutton.onclick = function () {
        ...
        if(reftextval != lastgettstext){
            ...
            var request = new XMLHttpRequest();
            request.open('POST', '/TTS/gettts', true);
    ...
    function getttsforword(word){
        var request = new XMLHttpRequest();
        request.open('POST', '/TTS/getttsforword', true);
        request.responseType = "blob";
    ...
    ttbutton.onclick = function () {
        ...
        request.open('POST', ' /spellcheck/getspell', true);
